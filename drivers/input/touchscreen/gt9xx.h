...
#define IMX_GPIO_TO_PIN(bank, nr)             (((bank) - 1) * 32 + (nr))     
#define GTP_RST_PORT    IMX_GPIO_NR(6, 16)//IMX_GPIO_TO_PIN(6, 7)
#define GTP_INT_PORT    IMX_GPIO_NR(6, 7)//IMX_GPIO_TO_PIN(4, 20)
